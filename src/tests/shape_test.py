...
class TestShape(unittest.TestCase):
    ...
    def test_shape_ctor(self):
        ...
        self.assertEqual(self.test_shape.coordinates,[[0, 4], [1, 4], [2, 4], [3, 4]])
    ...
    def test_move_shape_left(self):
        ...
        self.assertEqual(self.test_shape.coordinates, [[0, 3], [1, 3], [2, 3], [3, 3]])

    def test_move_shape_right(self):
        self.test_shape.move_shape('right', self.test_level)
        self.assertEqual(self.test_shape.coordinates, [[0, 5], [1, 5], [2, 5], [3, 5]])

    def test_check_no_collisions(self):
        self.assertTrue(self.test_shape.check_no_collisions(self.test_level))

    def test_check_no_collisions_when_there_is_a_collision(self):
        self.test_shape.coordinates = [[17, 4], [18, 4], [19, 4], [20, 4]]
        self.assertFalse(self.test_shape.check_no_collisions(self.test_level))
